  ...
  if (viewState === 'questions') {
    return (
      <IntelligenceQuestionForm
        ...
        description="We'll provide real-time exchange rates, ATM locations, tipping customs, and payment recommendations for each destination. All data is sourced from official APIs and government resources."
        questions={questions}
