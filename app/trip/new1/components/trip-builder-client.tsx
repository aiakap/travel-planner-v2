...
export function TripBuilderClient({ segmentTypeMap }: TripBuilderClientProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-slate-800 font-sans selection:bg-indigo-100 pt-20">
      {/* HEADER */}
      <div className="bg-white border-b border-gray-200 shadow-sm sticky top-20 z-50">
