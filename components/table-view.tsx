...
export function TableView({ segments, onSelectReservation, onChatAboutItem, onChatAboutSegment, onEditSegment, onEditItem }: TableViewProps) {  const [openContactMenu, setOpenContactMenu] = useState<number | null>(null)
